...
# 安装 skill 到目标项目（支持 Codex, cursor, codex, copilot）
...
# 同步入口文件（AGENTS.md → AGENTS.md/copilot-instructions/cursor rules）
...
AGENTS.md 是单一源（Single Source of Truth）：
- `AGENTS.md` — symlink 到 AGENTS.md
- `.github/copilot-instructions.md` — symlink 到 AGENTS.md
